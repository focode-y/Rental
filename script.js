...
const i18n = {
  zh: {
    ...
    hero_title: "民宿代运营、合规运营<br/>收益最大化一站式服务", hero_sub: "我们专注于民宿经营，从合规办理、平台运营、保洁管理到财务复盘四个方面，为业主提供清晰可执行、过程可追踪、结果可交付的运营方案。", hero_cta_1: "获取大阪方案", hero_cta_2: "查看30+在管实绩",
  ...
  hk: {
    ...
    hero_title: "民宿代營運、合規營運<br/>收益最大化一站式服務", hero_sub: "我們專注於民宿經營，從合規辦理、平台營運、保潔管理到財務復盤四個方面，為業主提供清晰可執行、過程可追蹤、結果可交付的營運方案。", hero_cta_1: "獲取大阪方案", hero_cta_2: "查看30+在管實績",
