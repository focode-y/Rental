...
const i18n = {
  ...
  hk: {
    ...
    hero_title: "民宿代營運、合規營運<br/>收益最大化一站式服務", hero_sub: "我們專注於民宿經營，從合規辦理、平台營運、保潔管理到財務復盤四個方面，為業主提供清晰可執行、過程可追蹤、結果可交付的營運方案。", hero_cta_1: "獲取大阪方案", hero_cta_2: "查看300+在管實績",
  ...
  ja: {
    ...
    hero_title: "民泊運営代行<br/>法令対応と収益改善を一体で", hero_sub: "私たちは民泊運営に特化し、法令対応、プラットフォーム運用、清掃管理、財務レビューの4つの側面から、実行しやすく、進捗を追跡でき、成果を明確に確認できる運営プランを提供します。", hero_cta_1: "大阪向け提案を受ける", hero_cta_2: "300件超の運営実績を見る",
    ...
    bench_title: "大阪300件超の運営実績", case_title: "実際の事例", reviews_title: "顧客レビュー",
